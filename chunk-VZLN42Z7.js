import{a as y}from"./chunk-S3I3S5BX.js";import{s as k,x as w}from"./chunk-CRAWC3BK.js";import{a as u}from"./chunk-SH6HWCPG.js";import"./chunk-CQCG3KCY.js";import{a as o}from"./chunk-WT6KFS7F.js";import{Ba as g,Ga as i,Pa as r,Qa as h,R as c,Ra as m,Xa as f,nb as j,ob as d,vc as b}from"./chunk-VLX6VUPD.js";import{a as t,b as p,g as S}from"./chunk-P2VZOJAX.js";var D=S(b());var C=(()=>{class s{constructor(){this.nodes=[{id:"1",point:{x:100,y:100},type:"default",text:"1"},{id:"2",point:{x:200,y:200},type:"default",text:"2"}],this.edges=[],this.connectionSettings={marker:{type:"arrow"}}}createEdge(a){this.edges=[...this.edges,p(t({},a),{id:`${a.source} -> ${a.target}`,markers:{start:{type:"arrow-closed"},end:{type:"arrow"}}})]}static{this.\u0275fac=function(n){return new(n||s)}}static{this.\u0275cmp=c({type:s,selectors:[["ng-component"]],standalone:!0,features:[d],decls:1,vars:3,consts:[["view","auto",3,"onConnect","nodes","edges","connection"]],template:function(n,e){n&1&&(r(0,"vflow",0),f("onConnect",function(_){return e.createEdge(_)}),h()),n&2&&i("nodes",e.nodes)("edges",e.edges)("connection",e.connectionSettings)},dependencies:[w,k],styles:["[_nghost-%COMP%]{width:100%;height:100%}"],changeDetection:0})}}return s})();var M={title:"Markers",mdFile:"./index.md",category:y,demos:{MarkersDemoComponent:C},order:5},l=M;var v=[];var P={MarkersDemoComponent:[{title:"TypeScript",code:`<pre class="ngde hljs"><code lang="typescript" class="hljs language-typescript code-lines ngde"><span class="line ngde"><span class="hljs-keyword ngde">import</span> { <span class="hljs-title class_ ngde">ChangeDetectionStrategy</span>, <span class="hljs-title class_ ngde">Component</span> } <span class="hljs-keyword ngde">from</span> <span class="hljs-string ngde">'@angular/core'</span>;
