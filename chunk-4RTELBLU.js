import{a as L}from"./chunk-S3I3S5BX.js";import{e as _,n as D}from"./chunk-OTAEONLZ.js";import"./chunk-YV53NWFE.js";import"./chunk-IQL2UJ6C.js";import"./chunk-IO7LDB7E.js";import{a as k}from"./chunk-VYAX5YUU.js";import"./chunk-WI2JOD2Y.js";import{a as g}from"./chunk-34LC2K2P.js";import{T as R}from"./chunk-MU5S45C6.js";import{$b as d,Ac as t,Ga as r,Gb as j,Ha as h,Ob as m,Sb as f,Tb as u,ac as c,bc as b,fc as x,hc as y,ic as v,tc as w,wa as p,zc as C}from"./chunk-WSOERDLG.js";import{a as i,b as o,g as V}from"./chunk-P2VZOJAX.js";var S=V(R());function I(s,T){if(s&1){let a=x();d(0,"div",2),y("click",function(){let e=r(a).$implicit,O=v();return h(O.deleteEdge(e.edge))}),w(1,"Delete"),c()}if(s&2){let a=T.$implicit;u("background-color",a.label.data.color)}}var E=(()=>{class s{constructor(){this.nodes=[{id:"1",point:{x:10,y:200},type:"default",text:"1"},{id:"2",point:{x:200,y:100},type:"default",text:"2"},{id:"3",point:{x:200,y:300},type:"default",text:"3"}],this.edges=[{id:"1 -> 2",source:"1",target:"2",edgeLabels:{center:{type:"html-template",data:{color:"#122c26"}}}},{id:"1 -> 3",source:"1",target:"3",edgeLabels:{center:{type:"html-template",data:{color:"#8b599a"}}}}]}deleteEdge(a){this.edges=this.edges.filter(n=>n!==a)}static{this.\u0275fac=function(n){return new(n||s)}}static{this.\u0275cmp=p({type:s,selectors:[["ng-component"]],standalone:!0,features:[t],decls:2,vars:2,consts:[["view","auto",3,"nodes","edges"],["edgeLabelHtml",""],[1,"label",3,"click"]],template:function(n,e){n&1&&(d(0,"vflow",0),m(1,I,2,2,"ng-template",1),c()),n&2&&f("nodes",e.nodes)("edges",e.edges)},dependencies:[D,_],styles:["[_nghost-%COMP%]{width:100%;height:100%}.label[_ngcontent-%COMP%]{width:60px;height:25px;background-color:#122c26;border-radius:5px;text-align:center}"],changeDetection:0})}}return s})();var F={title:"Labels",mdFile:"./index.md",category:L,demos:{LabelsDemoComponent:E},order:2},l=F;var P=[];var M={LabelsDemoComponent:[{title:"TypeScript",code:`<pre class="ngde hljs"><code lang="typescript" class="hljs language-typescript code-lines ngde"><span class="line ngde"><span class="hljs-keyword ngde">import</span> { <span class="hljs-title class_ ngde">ChangeDetectionStrategy</span>, <span class="hljs-title class_ ngde">Component</span> } <span class="hljs-keyword ngde">from</span> <span class="hljs-string ngde">'@angular/core'</span>;
