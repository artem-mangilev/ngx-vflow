import{a as E}from"./chunk-UUHU3CBA.js";import"./chunk-S3I3S5BX.js";import{j as L,z as _}from"./chunk-AQENXFQJ.js";import"./chunk-NA7FJBPQ.js";import{a as C}from"./chunk-ZBKCENK6.js";import"./chunk-G5N4YGVJ.js";import{a as g}from"./chunk-AKRIWIS4.js";import{T as V}from"./chunk-QMHLIXQX.js";import{$b as d,Ac as t,Ga as r,Gb as j,Ha as h,Ob as f,Qb as m,Rb as u,ac as c,bc as x,fc as y,hc as b,ic as k,tc as v,wa as p,zc as w}from"./chunk-Z42XPK5A.js";import{a as i,b as o,g as N}from"./chunk-ODLL2QMY.js";var P=N(V());function z(s,O){if(s&1){let a=y();d(0,"div",2),b("click",function(){let e=r(a).$implicit,R=k();return h(R.deleteEdge(e.edge))}),v(1,"Delete"),c()}if(s&2){let a=O.$implicit;u("background-color",a.label.data.color)}}var D=(()=>{class s{constructor(){this.nodes=[{id:"1",point:{x:50,y:200},type:"default",text:"1"},{id:"2",point:{x:350,y:100},type:"default",text:"2"},{id:"3",point:{x:350,y:300},type:"default",text:"3"}],this.edges=[{id:"1 -> 2",source:"1",target:"2",curve:"smooth-step",edgeLabels:{start:{type:"default",text:"Start",style:{background:"#e3f2fd",color:"#1976d2",padding:"2px 6px",borderRadius:"12px",fontSize:"11px",fontWeight:"500"}},center:{type:"html-template",data:{color:"#122c26"}},end:{type:"default",text:"End",style:{background:"#e8f5e8",color:"#2e7d32",padding:"2px 6px",borderRadius:"12px",fontSize:"11px",fontWeight:"500"}}}},{id:"1 -> 3",source:"1",target:"3",curve:"smooth-step",edgeLabels:{center:{type:"default",text:"Center Only",style:{color:"black",background:"#f5f5f5",padding:"4px 8px",borderRadius:"4px",fontSize:"12px"}}}}]}deleteEdge(a){this.edges=this.edges.filter(n=>n!==a)}static{this.\u0275fac=function(n){return new(n||s)}}static{this.\u0275cmp=p({type:s,selectors:[["ng-component"]],standalone:!0,features:[t],decls:2,vars:2,consts:[["view","auto",3,"nodes","edges"],["edgeLabelHtml",""],[1,"label",3,"click"]],template:function(n,e){n&1&&(d(0,"vflow",0),f(1,z,2,2,"ng-template",1),c()),n&2&&m("nodes",e.nodes)("edges",e.edges)},dependencies:[_,L],styles:["[_nghost-%COMP%]{width:100%;height:100%}.label[_ngcontent-%COMP%]{width:60px;height:25px;background-color:#122c26;border-radius:5px;text-align:center}"],changeDetection:0})}}return s})();var M={title:"Labels",mdFile:"./index.md",category:E,demos:{LabelsDemoComponent:D},order:5},l=M;var S=[];var F={LabelsDemoComponent:[{title:"TypeScript",code:`<pre class="ngde hljs"><code lang="typescript" class="hljs language-typescript code-lines ngde"><span class="line ngde"><span class="hljs-keyword ngde">import</span> { <span class="hljs-title class_ ngde">ChangeDetectionStrategy</span>, <span class="hljs-title class_ ngde">Component</span> } <span class="hljs-keyword ngde">from</span> <span class="hljs-string ngde">'@angular/core'</span>;
...
</span><span class="line ngde">      <span class="hljs-attr ngde">point</span>: { <span class="hljs-attr ngde">x</span>: <span class="hljs-number ngde">50</span>, <span class="hljs-attr ngde">y</span>: <span class="hljs-number ngde">200</span> },
...
</span><span class="line ngde">      <span class="hljs-attr ngde">point</span>: { <span class="hljs-attr ngde">x</span>: <span class="hljs-number ngde">350</span>, <span class="hljs-attr ngde">y</span>: <span class="hljs-number ngde">100</span> },
</span><span class="line ngde">      <span class="hljs-attr ngde">type</span>: <span class="hljs-string ngde">'default'</span>,
...
</span><span class="line ngde">      <span class="hljs-attr ngde">point</span>: { <span class="hljs-attr ngde">x</span>: <span class="hljs-number ngde">350</span>, <span class="hljs-attr ngde">y</span>: <span class="hljs-number ngde">300</span> },
</span><span class="line ngde">      <span class="hljs-attr ngde">type</span>: <span class="hljs-string ngde">'default'</span>,
...
</span><span class="line ngde">          <span class="hljs-attr ngde">text</span>: <span class="hljs-string ngde">'Start'</span>,
</span><span class="line ngde">          <span class="hljs-attr ngde">style</span>: {
</span><span class="line ngde">            <span class="hljs-attr ngde">background</span>: <span class="hljs-string ngde">'#e3f2fd'</span>,
</span><span class="line ngde">            <span class="hljs-attr ngde">color</span>: <span class="hljs-string ngde">'#1976d2'</span>,
</span><span class="line ngde">            <span class="hljs-attr ngde">padding</span>: <span class="hljs-string ngde">'2px 6px'</span>,
</span><span class="line ngde">            <span class="hljs-attr ngde">borderRadius</span>: <span class="hljs-string ngde">'12px'</span>,
</span><span class="line ngde">            <span class="hljs-attr ngde">fontSize</span>: <span class="hljs-string ngde">'11px'</span>,
</span><span class="line ngde">            <span class="hljs-attr ngde">fontWeight</span>: <span class="hljs-string ngde">'500'</span>,
</span><span class="line ngde">          },
</span><span class="line ngde">        },
...
</span><span class="line ngde">          <span class="hljs-attr ngde">text</span>: <span class="hljs-string ngde">'End'</span>,
</span><span class="line ngde">          <span class="hljs-attr ngde">style</span>: {
</span><span class="line ngde">            <span class="hljs-attr ngde">background</span>: <span class="hljs-string ngde">'#e8f5e8'</span>,
</span><span class="line ngde">            <span class="hljs-attr ngde">color</span>: <span class="hljs-string ngde">'#2e7d32'</span>,
</span><span class="line ngde">            <span class="hljs-attr ngde">padding</span>: <span class="hljs-string ngde">'2px 6px'</span>,
</span><span class="line ngde">            <span class="hljs-attr ngde">borderRadius</span>: <span class="hljs-string ngde">'12px'</span>,
</span><span class="line ngde">            <span class="hljs-attr ngde">fontSize</span>: <span class="hljs-string ngde">'11px'</span>,
</span><span class="line ngde">            <span class="hljs-attr ngde">fontWeight</span>: <span class="hljs-string ngde">'500'</span>,
...
</span><span class="line ngde">          <span class="hljs-attr ngde">text</span>: <span class="hljs-string ngde">'Center Only'</span>,
</span><span class="line ngde">          <span class="hljs-attr ngde">style</span>: {
</span><span class="line ngde">            <span class="hljs-attr ngde">color</span>: <span class="hljs-string ngde">'black'</span>,
</span><span class="line ngde">            <span class="hljs-attr ngde">background</span>: <span class="hljs-string ngde">'#f5f5f5'</span>,
</span><span class="line ngde">            <span class="hljs-attr ngde">padding</span>: <span class="hljs-string ngde">'4px 8px'</span>,
</span><span class="line ngde">            <span class="hljs-attr ngde">borderRadius</span>: <span class="hljs-string ngde">'4px'</span>,
</span><span class="line ngde">            <span class="hljs-attr ngde">fontSize</span>: <span class="hljs-string ngde">'12px'</span>,
</span><span class="line ngde">          },
</span><span class="line ngde">        },
</span><span class="line ngde">      },
</span><span class="line ngde">    },
...
</span></code></pre><h2 id="example" class="ngde">Example<a title="Link to heading" class="ng-doc-header-link ngde" href="/features/edges/labels#example"><ng-doc-icon icon="link-2" size="16" class="ngde"></ng-doc-icon></a></h2><ng-doc-demo-pane componentname="LabelsDemoComponent" indexable="false" class="ngde"><div id="options" class="ngde">{}</div></ng-doc-demo-pane>`,H=(()=>{class s extends g{constructor(){super(),this.routePrefix="",this.pageType="guide",this.pageContent=I,this.editSourceFileUrl="https://github.com/artem-mangilev/ngx-vflow/edit/main/projects/ngx-vflow-demo/src/app/categories/features/categories/edges/labels/index.md?message=docs(labels): describe your changes here...",this.page=l,this.demoAssets=T}static{this.\u0275fac=function(n){return new(n||s)}}static{this.\u0275cmp=p({type:s,selectors:[["ng-doc-page-features-edges-labels"]],standalone:!0,features:[w([{provide:g,useExisting:s},S,l.providers??[]]),j,t],decls:1,vars:0,template:function(n,e){n&1&&x(0,"ng-doc-page")},dependencies:[C],encapsulation:2,changeDetection:0})}}return s})(),Y=[o(i({},(0,P.isRoute)(l.route)?l.route:{}),{path:"",component:H,title:"Labels"})],ns=Y;export{H as DynamicComponent,ns as default};
