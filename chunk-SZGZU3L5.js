...
</span></code></pre><h2 id="example" class="ngde">Example<a title="Link to heading" class="ng-doc-header-link ngde" href="/features/edges/custom-edges#example"><ng-doc-icon icon="link-2" size="16" class="ngde"></ng-doc-icon></a></h2><ng-doc-demo-pane componentname="CustomEdgesDemoComponent" indexable="false" class="ngde"><div id="options" class="ngde">{}</div></ng-doc-demo-pane>`,R=(()=>{class s extends c{constructor(){super(),this.routePrefix="",this.pageType="guide",this.pageContent=A,this.editSourceFileUrl="https://github.com/artem-mangilev/ngx-vflow/edit/main/projects/ngx-vflow-demo/src/app/categories/features/categories/edges/custom-edges/index.md?message=docs(custom-edges): describe your changes here...",this.page=e,this.demoAssets=E}static{this.\u0275fac=function(a){return new(a||s)}}static{this.\u0275cmp=l({type:s,selectors:[["ng-doc-page-features-edges-custom-edges"]],standalone:!0,features:[y([{provide:c,useExisting:s},D,e.providers??[]]),r,p],decls:1,vars:0,template:function(a,d){a&1&&t(0,"ng-doc-page")},dependencies:[x],encapsulation:2,changeDetection:0})}}return s})(),F=[i(g({},(0,_.isRoute)(e.route)?e.route:{}),{path:"",component:R,title:"Custom edges"})],J=F;export{R as DynamicComponent,J as default};
