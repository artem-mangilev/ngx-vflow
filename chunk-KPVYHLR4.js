import{a as E}from"./chunk-O7YUPJSJ.js";import{a as P}from"./chunk-DV74VKYN.js";import"./chunk-S3I3S5BX.js";import{l as T,w as S,y as O}from"./chunk-UKKUZNX5.js";import{a as D}from"./chunk-R2FYFHTZ.js";import"./chunk-FGWLUFMG.js";import{a as _}from"./chunk-JLOZFYHF.js";import{Ba as N,Ea as f,Ga as g,Ma as b,R as r,Ra as e,Sa as l,Ta as t,Xa as y,Y as u,Z as x,Za as C,_a as d,jb as c,na as i,pb as k,qb as h,wc as I}from"./chunk-VFFNGGE6.js";import{a as v,b as w,g as R}from"./chunk-ODLL2QMY.js";var M=R(I());function U(s,j){if(s&1){let n=y();e(0,"div",2)(1,"div",3),c(2," Output 1 "),t(3,"handle",4),l(),e(4,"div",3),c(5," Output 2 "),t(6,"handle",4),l()(),e(7,"node-toolbar",5)(8,"button",6),C("click",function(){u(n);let p=d().$implicit,m=d();return x(m.deleteNode(p.node))}),c(9,"Delete"),l()()}if(s&2){let n=d().$implicit;i(3),g("id",n.node.data.output1),i(3),g("id",n.node.data.output2)}}function L(s,j){if(s&1){let n=y();e(0,"div",2)(1,"div",3),c(2," Input 1 "),t(3,"handle",7),l(),e(4,"div",3),c(5," Input 2 "),t(6,"handle",7),l()(),e(7,"node-toolbar",8)(8,"button",6),C("click",function(){u(n);let p=d().$implicit,m=d();return x(m.deleteNode(p.node))}),c(9,"Delete"),l()()}if(s&2){let n=d().$implicit;i(3),g("id",n.node.data.input1),i(3),g("id",n.node.data.input2)}}function Y(s,j){if(s&1&&f(0,U,10,2)(1,L,10,2),s&2){let n=j.$implicit;b(0,n.node.data.type==="output"?0:-1),i(),b(1,n.node.data.type==="input"?1:-1)}}var V=(()=>{class s{constructor(){this.nodes=[{id:"1",point:{x:60,y:150},type:"html-template",data:{type:"output",output1:"output1",output2:"output2"}},{id:"2",point:{x:300,y:100},type:"html-template",data:{type:"input",input1:"input1",input2:"input2"}}],this.edges=[{id:"1 -> 2 one",source:"1",target:"2",sourceHandle:"output1",targetHandle:"input1"},{id:"1 -> 2 two",source:"1",target:"2",sourceHandle:"output2",targetHandle:"input2"}]}deleteNode(n){this.nodes=this.nodes.filter(a=>a.id!==n.id)}static{this.\u0275fac=function(a){return new(a||s)}}static{this.\u0275cmp=r({type:s,selectors:[["ng-component"]],standalone:!0,features:[h],decls:2,vars:2,consts:[["view","auto",3,"nodes","edges"],["nodeHtml",""],[1,"custom-node"],[1,"data-block"],["position","right","type","source",3,"id"],["position","left"],[3,"click"],["position","left","type","target",3,"id"],["position","right"]],template:function(a,p){a&1&&(e(0,"vflow",0),f(1,Y,2,2,"ng-template",1),l()),a&2&&g("nodes",p.nodes)("edges",p.edges)},dependencies:[O,S,E,T],styles:["[_nghost-%COMP%]{width:100%;height:100%}.custom-node[_ngcontent-%COMP%]{width:150px;height:100px;background-color:#0f4c75;border:1px solid gray;border-radius:5px;align-items:center;padding-left:7px;padding-right:7px}.data-block[_ngcontent-%COMP%]{background-color:#fff;color:#1b262c;margin-top:15px;border-radius:5px;text-align:center}"],changeDetection:0})}}return s})();var $={title:"Node toolbar",mdFile:"./index.md",category:P,demos:{NodeToolbarDemoComponent:V},order:5},o=$;var H=[];var G={NodeToolbarDemoComponent:[{title:"TypeScript",code:`<pre class="ngde hljs"><code lang="typescript" class="hljs language-typescript code-lines ngde"><span class="line ngde"><span class="hljs-keyword ngde">import</span> { <span class="hljs-title class_ ngde">ChangeDetectionStrategy</span>, <span class="hljs-title class_ ngde">Component</span> } <span class="hljs-keyword ngde">from</span> <span class="hljs-string ngde">'@angular/core'</span>;
...
</span></code></pre>`}]},A=G;var z='<h1 id="node-toolbar" class="ngde">Node toolbar<a title="Link to heading" class="ng-doc-header-link ngde" href="/features/nodes/node-toolbar#node-toolbar"><ng-doc-icon icon="link-2" size="16" class="ngde"></ng-doc-icon></a></h1><p class="ngde">You can add a <code class="ngde ng-doc-code-with-link" class="ngde"><a href="/api/ngx-vflow/classes/NodeToolbarComponent" class="ng-doc-code-anchor ngde" data-link-type="Component" class="ngde">NodeToolbarComponent</a></code> to your node. The content of this component is automatically positioned near one side of the node, based on the value of the <code class="ngde">position</code> input.</p><ng-doc-demo-pane componentname="NodeToolbarDemoComponent" indexable="false" class="ngde"><div id="options" class="ngde">{}</div></ng-doc-demo-pane>',q=(()=>{class s extends _{constructor(){super(),this.routePrefix="",this.pageType="guide",this.pageContent=z,this.editSourceFileUrl="https://github.com/artem-mangilev/ngx-vflow/edit/main/projects/ngx-vflow-demo/src/app/categories/features/categories/nodes/node-toolbar/index.md?message=docs(node-toolbar): describe your changes here...",this.page=o,this.demoAssets=A}static{this.\u0275fac=function(a){return new(a||s)}}static{this.\u0275cmp=r({type:s,selectors:[["ng-doc-page-features-nodes-node-toolbar"]],standalone:!0,features:[k([{provide:_,useExisting:s},H,o.providers??[]]),N,h],decls:1,vars:0,template:function(a,p){a&1&&t(0,"ng-doc-page")},dependencies:[D],encapsulation:2,changeDetection:0})}}return s})(),B=[w(v({},(0,M.isRoute)(o.route)?o.route:{}),{path:"",component:q,title:"Node toolbar"})],ts=B;export{q as DynamicComponent,ts as default};
