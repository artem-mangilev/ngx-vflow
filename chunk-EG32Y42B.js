...
</span></code></pre><ng-doc-demo-pane componentname="CustomHandlesDemoComponent" indexable="false" class="ngde"><div id="options" class="ngde">{}</div></ng-doc-demo-pane>`,ss=(()=>{class n extends v{constructor(){super(),this.routePrefix="",this.pageType="guide",this.pageContent=Z,this.editSourceFileUrl="https://github.com/artem-mangilev/ngx-vflow/edit/main/projects/ngx-vflow-demo/src/app/categories/features/pages/custom-handles/index.md?message=docs(custom-handles): describe your changes here...",this.page=r,this.demoAssets=F}static{this.\u0275fac=function(a){return new(a||n)}}static{this.\u0275cmp=j({type:n,selectors:[["ng-doc-page-features-custom-handles"]],standalone:!0,features:[E([{provide:v,useExisting:n},A,r.providers??[]]),S,u],decls:1,vars:0,template:function(a,l){a&1&&e(0,"ng-doc-page")},dependencies:[O],encapsulation:2,changeDetection:0})}}return n})(),ns=[w(_({},(0,G.isRoute)(r.route)?r.route:{}),{path:"",component:ss,title:"Custom handles"})],ms=ns;export{ss as DynamicComponent,ms as default};
