import{a as D}from"./chunk-C5I5PISW.js";import{a as O}from"./chunk-S3I3S5BX.js";import{n as E}from"./chunk-3MEYFIMA.js";import"./chunk-IQL2UJ6C.js";import"./chunk-YV53NWFE.js";import"./chunk-IO7LDB7E.js";import{a as I}from"./chunk-VYAX5YUU.js";import"./chunk-WI2JOD2Y.js";import{a as S}from"./chunk-34LC2K2P.js";import{T as Q}from"./chunk-MU5S45C6.js";import{$b as g,Ac as m,Eb as C,Ga as p,Gb as A,Ha as t,Jc as k,Ob as _,Sb as v,ac as c,bc as H,fc as w,hc as f,ic as N,pb as o,qc as x,ra as y,rc as b,tc as h,uc as j,wa as r,zc as F}from"./chunk-WSOERDLG.js";import{a as T,b as V,g as z}from"./chunk-P2VZOJAX.js";var M=z(Q());var q=["toast"];function G(a,L){if(a&1&&(g(0,"h3"),h(1),c(),g(2,"pre"),h(3),c()),a&2){let s=N();o(),j(s.toastData==null?null:s.toastData.title),o(2),j(s.toastData==null?null:s.toastData.json)}}var $=(()=>{class a{constructor(){this.notifyService=y(D),this.toastTemplate=C("toast"),this.nodes=[{id:"1",point:{x:100,y:100},type:"default",text:"1"},{id:"2",point:{x:200,y:200},type:"default",text:"2"}],this.edges=[],this.toastData={}}createEdge({source:s,target:n}){this.edges=[...this.edges,{id:`${s} -> ${n}`,source:s,target:n}]}handleNodeChanges(s){this.toastData={title:"(onNodesChange)",json:JSON.stringify(s,null,2)},this.notifyService.notify(this.toastTemplate())}handleEdgeChanges(s){this.toastData={title:"(onEdgesChange)",json:JSON.stringify(s,null,2)},this.notifyService.notify(this.toastTemplate())}static{this.\u0275fac=function(n){return new(n||a)}}static{this.\u0275cmp=r({type:a,selectors:[["ng-component"]],viewQuery:function(n,e){n&1&&x(e.toastTemplate,q,5),n&2&&b()},standalone:!0,features:[m],decls:3,vars:2,consts:[["toast",""],["view","auto",3,"onConnect","onNodesChange","onEdgesChange","nodes","edges"]],template:function(n,e){if(n&1){let d=w();g(0,"vflow",1),f("onConnect",function(l){return p(d),t(e.createEdge(l))})("onNodesChange",function(l){return p(d),t(e.handleNodeChanges(l))})("onEdgesChange",function(l){return p(d),t(e.handleEdgeChanges(l))}),c(),_(1,G,4,2,"ng-template",null,0,k)}n&2&&v("nodes",e.nodes)("edges",e.edges)},dependencies:[E],styles:["[_nghost-%COMP%]{width:100%;height:100%}"],changeDetection:0})}}return a})();var W=["toast"];function B(a,L){if(a&1&&(g(0,"h3"),h(1),c(),g(2,"pre"),h(3),c()),a&2){let s=N();o(),j(s.toastData==null?null:s.toastData.title),o(2),j(s.toastData==null?null:s.toastData.json)}}var R=(()=>{class a{constructor(){this.notifyService=y(D),this.toastTemplate=C("toast"),this.nodes=[{id:"1",point:{x:100,y:100},type:"default",text:"1"},{id:"2",point:{x:200,y:200},type:"default",text:"2"}],this.edges=[],this.toastData={}}createEdge({source:s,target:n}){this.edges=[...this.edges,{id:`${s} -> ${n}`,source:s,target:n}]}handleNodePositionChange(s){this.toastData={title:"(onNodesChange.position.single)",json:JSON.stringify(s,null,2)},this.notifyService.notify(this.toastTemplate())}handleNodeSelectChange(s){this.toastData={title:"(onNodesChange.select.single)",json:JSON.stringify(s,null,2)},this.notifyService.notify(this.toastTemplate())}handleNodesAddChange(s){this.toastData={title:"(onNodesChange.add.many)",json:JSON.stringify(s,null,2)},this.notifyService.notify(this.toastTemplate())}handleEdgesAddChange(s){this.toastData={title:"(onEdgesChange.add)",json:JSON.stringify(s,null,2)},this.notifyService.notify(this.toastTemplate())}addNodes(){this.nodes=[...this.nodes,{id:crypto.randomUUID(),point:{x:0,y:0},type:"default",text:"random"},{id:crypto.randomUUID(),point:{x:300,y:300},type:"default",text:"random"}]}static{this.\u0275fac=function(n){return new(n||a)}}static{this.\u0275cmp=r({type:a,selectors:[["ng-component"]],viewQuery:function(n,e){n&1&&x(e.toastTemplate,W,5),n&2&&b()},standalone:!0,features:[m],decls:5,vars:2,consts:[["toast",""],[3,"click"],["view","auto",3,"onConnect","onNodesChange.position.single","onNodesChange.select.single","onNodesChange.add.many","onEdgesChange.add","nodes","edges"]],template:function(n,e){if(n&1){let d=w();g(0,"button",1),f("click",function(){return p(d),t(e.addNodes())}),h(1,"Add nodes"),c(),g(2,"vflow",2),f("onConnect",function(l){return p(d),t(e.createEdge(l))})("onNodesChange.position.single",function(l){return p(d),t(e.handleNodePositionChange(l))})("onNodesChange.select.single",function(l){return p(d),t(e.handleNodeSelectChange(l))})("onNodesChange.add.many",function(l){return p(d),t(e.handleNodesAddChange(l))})("onEdgesChange.add",function(l){return p(d),t(e.handleEdgesAddChange(l))}),c(),_(3,B,4,2,"ng-template",null,0,k)}n&2&&(o(2),v("nodes",e.nodes)("edges",e.edges))},dependencies:[E],styles:["[_nghost-%COMP%]{width:100%;height:100%}"],changeDetection:0})}}return a})();var K={title:"Handling changes",mdFile:"./index.md",category:O,keyword:"FeaturesHandlingChanges",demos:{HandlingChangesDemoComponent:$,HandlingChangesFilteredDemoComponent:R},order:3},u=K;var U=[];var X={HandlingChangesDemoComponent:[{title:"TypeScript",code:`<pre class="ngde hljs"><code lang="typescript" class="hljs language-typescript code-lines ngde"><span class="line ngde"><span class="hljs-keyword ngde">import</span> {
...
</span><span class="line ngde">  <span class="hljs-title class_ ngde">TemplateRef</span>,
...
</span><span class="line ngde">  <span class="hljs-title class_ ngde"><a href="/api/ngx-vflow/type-aliases/NodeChange" class="ng-doc-code-anchor ngde" data-link-type="TypeAlias" class="ngde">NodeChange</a></span>,
...
</span><span class="line ngde">  <span class="hljs-keyword ngde">public</span> toastTemplate = viewChild&#x3C;<span class="hljs-title class_ ngde">TemplateRef</span>&#x3C;{}>>(<span class="hljs-string ngde">'toast'</span>);
</span><span class="line ngde">
...
</span></code></pre>`}],HandlingChangesFilteredDemoComponent:[{title:"TypeScript",code:`<pre class="ngde hljs"><code lang="typescript" class="hljs language-typescript code-lines ngde"><span class="line ngde"><span class="hljs-keyword ngde">import</span> {
</span><span class="line ngde">  <span class="hljs-title class_ ngde">ChangeDetectionStrategy</span>,
</span><span class="line ngde">  <span class="hljs-title class_ ngde">Component</span>,
</span><span class="line ngde">  <span class="hljs-title class_ ngde">TemplateRef</span>,
</span><span class="line ngde">  inject,
...
</span></code></pre>`,ss=(()=>{class a extends S{constructor(){super(),this.routePrefix="",this.pageType="guide",this.pageContent=Z,this.editSourceFileUrl="https://github.com/artem-mangilev/ngx-vflow/edit/main/projects/ngx-vflow-demo/src/app/categories/features/pages/handling-changes/index.md?message=docs(handling-changes): describe your changes here...",this.page=u,this.demoAssets=J}static{this.\u0275fac=function(n){return new(n||a)}}static{this.\u0275cmp=r({type:a,selectors:[["ng-doc-page-features-handling-changes"]],standalone:!0,features:[F([{provide:S,useExisting:a},U,u.providers??[]]),A,m],decls:1,vars:0,template:function(n,e){n&1&&H(0,"ng-doc-page")},dependencies:[I],encapsulation:2,changeDetection:0})}}return a})(),ns=[V(T({},(0,M.isRoute)(u.route)?u.route:{}),{path:"",component:ss,title:"Handling changes"})],Ns=ns;export{ss as DynamicComponent,Ns as default};
