import{a as _}from"./chunk-OP7MV3W5.js";import{a as M}from"./chunk-Q6EMBRWW.js";import{a as C}from"./chunk-S3I3S5BX.js";import{l as b,u as D,w as k}from"./chunk-WPOQ3LVW.js";import{a as v}from"./chunk-GPBMHN32.js";import"./chunk-MUKF72JZ.js";import{a as r}from"./chunk-T6GQPSCF.js";import{Ba as u,Ea as f,Fa as y,Ga as d,Ha as x,R as p,Ra as g,Sa as c,Ta as e,_ as m,na as j,pb as w,qb as t,xc as T}from"./chunk-FDES3R26.js";import{a as o,b as h,g as I}from"./chunk-P2VZOJAX.js";var S=I(T());function V(s,E){if(s&1&&(m(),g(0,"rect",3),e(1,"handle",4),c()),s&2){let a=E.$implicit;x("stroke","red")("fill","red")("fill-opacity",.05)("stroke-width",a.selected()?3:1),y("width",a.width())("height",a.height())}}var P=(()=>{class s{constructor(){this.nodes=[{id:"1",point:{x:10,y:10},type:"default",text:"1",parentId:"3"},{id:"2",point:{x:90,y:80},type:"default",text:"<strong>2</strong>",parentId:"3"},{id:"3",point:{x:10,y:10},type:"default-group",width:250,height:250},{id:"4",point:{x:280,y:10},type:"default",text:"4"},{id:"5",point:{x:10,y:160},type:"template-group",width:170,height:70,parentId:"3"},{id:"6",point:{x:10,y:10},type:"default",text:"6",parentId:"5"}],this.edges=[{source:"1",target:"2",id:"1 -> 2"},{source:"2",target:"4",id:"2 -> 4"},{source:"5",target:"4",id:"5 -> 4"}]}static{this.\u0275fac=function(n){return new(n||s)}}static{this.\u0275cmp=p({type:s,selectors:[["ng-component"]],standalone:!0,features:[t],decls:3,vars:3,consts:[["view","auto",3,"nodes","edges"],["groupNode",""],[3,"scaleOnHover"],["selectable","","rx","5","ry","5"],["type","source","position","right"]],template:function(n,i){n&1&&(g(0,"vflow",0),f(1,V,2,10,"ng-template",1),e(2,"mini-map",2),c()),n&2&&(d("nodes",i.nodes)("edges",i.edges),j(2),d("scaleOnHover",!0))},dependencies:[k,D,M,_,b],styles:["[_nghost-%COMP%]{width:100%;height:100%}"],changeDetection:0})}}return s})();var A={title:"Minimap",mdFile:"./index.md",category:C,demos:{MinimapDemoComponent:P},order:1},l=A;var N=[];var F={MinimapDemoComponent:[{title:"TypeScript",code:`<pre class="ngde hljs"><code lang="typescript" class="hljs language-typescript code-lines ngde"><span class="line ngde"><span class="hljs-keyword ngde">import</span> { <span class="hljs-title class_ ngde">ChangeDetectionStrategy</span>, <span class="hljs-title class_ ngde">Component</span> } <span class="hljs-keyword ngde">from</span> <span class="hljs-string ngde">'@angular/core'</span>;
