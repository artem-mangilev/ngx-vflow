...
```html
<span vflowHandle handleType="target" position="left" id="incoming" ariaLabel="Approve expense" ariaDescription="Inbound review route." [canStart]="false" [canAccept]="true" [domAttributes]="{ 'data-port': 'review' }"></span>
```
