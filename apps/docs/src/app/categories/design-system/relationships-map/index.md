...
- A `vflowContainer` on a group node (a node with a size and children) carries its own handles and edges; membership of people in a team is graph data, not a visual rule.
