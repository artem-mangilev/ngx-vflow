import{a as H}from"./chunk-7YR6GUZX.js";import{a as k}from"./chunk-S3I3S5BX.js";import{f as _,n as i}from"./chunk-3MEYFIMA.js";import{j as N}from"./chunk-IQL2UJ6C.js";import{a as S}from"./chunk-ALJMEAIF.js";import"./chunk-YV53NWFE.js";import"./chunk-IO7LDB7E.js";import{a as C}from"./chunk-VYAX5YUU.js";import"./chunk-WI2JOD2Y.js";import{a as j}from"./chunk-34LC2K2P.js";import{T as R}from"./chunk-MU5S45C6.js";import{$b as r,Ac as t,Gb as x,Oa as y,Ob as w,Sb as c,Ub as D,ac as g,bc as p,ra as o,tc as h,wa as l,ya as b,zc as v}from"./chunk-WSOERDLG.js";import{a as u,b as f,g as F}from"./chunk-P2VZOJAX.js";var A=F(R());var P=(()=>{class s{get model(){return this.nodeAccessor.model()}constructor(){this.nodeAccessor=o(N),this.model.dragHandlesCount.update(a=>a+1),o(y).onDestroy(()=>{this.model.dragHandlesCount.update(a=>a-1)})}static{this.\u0275fac=function(n){return new(n||s)}}static{this.\u0275dir=b({type:s,selectors:[["","dragHandle",""]],hostAttrs:[1,"vflow-drag-handle"],standalone:!0})}}return s})();var E=(()=>{class s{constructor(){this.nodes=[{id:"1",point:{x:10,y:200},type:"default",text:"1"},{id:"2",point:{x:200,y:100},type:"default",text:"2",draggable:!1},{id:"3",point:{x:200,y:300},type:"default",text:"3",draggable:!1}],this.edges=[{id:"1 -> 2",source:"1",target:"2"},{id:"1 -> 3",source:"1",target:"3"}]}static{this.\u0275fac=function(n){return new(n||s)}}static{this.\u0275cmp=l({type:s,selectors:[["ng-component"]],standalone:!0,features:[t],decls:1,vars:2,consts:[["view","auto",3,"nodes","edges"]],template:function(n,e){n&1&&p(0,"vflow",0),n&2&&c("nodes",e.nodes)("edges",e.edges)},dependencies:[i],styles:["[_nghost-%COMP%]{width:100%;height:100%}"],changeDetection:0})}}return s})();function L(s,M){if(s&1&&(r(0,"div",2)(1,"button",3),h(2,"Drag here"),g(),p(3,"handle",4)(4,"handle",5),g()),s&2){let a=M.$implicit;D("custom-node_selected",a.selected())}}var O=(()=>{class s{constructor(){this.nodes=[{id:"1",point:{x:10,y:150},type:"html-template"},{id:"2",point:{x:290,y:50},type:"html-template"},{id:"3",point:{x:290,y:300},type:"html-template"}],this.edges=[{id:"1 -> 2",source:"1",target:"2",type:"default"},{id:"1 -> 3",source:"1",target:"3",type:"default"}]}static{this.\u0275fac=function(n){return new(n||s)}}static{this.\u0275cmp=l({type:s,selectors:[["ng-component"]],standalone:!0,features:[t],decls:3,vars:2,consts:[["view","auto",3,"nodes","edges"],["nodeHtml",""],[1,"custom-node"],["dragHandle","","selectable","",1,"custom-node__button"],["type","source","position","right"],["type","target","position","left"]],template:function(n,e){n&1&&(r(0,"vflow",0),w(1,L,5,2,"ng-template",1),g(),h(2,"`\n")),n&2&&c("nodes",e.nodes)("edges",e.edges)},dependencies:[i,S,H,P,_],styles:["[_nghost-%COMP%]{width:100%;height:100%}.custom-node[_ngcontent-%COMP%]{width:150px;height:100px;background:#bbe1fa;border:1px solid gray;border-radius:5px;display:flex;align-items:center;justify-content:center}.custom-node__button[_ngcontent-%COMP%]{border:0;outline:0;cursor:pointer;color:#fff;background-color:#1b262c;border-radius:4px;font-size:14px;font-weight:500;padding:4px 8px;display:inline-block;min-height:28px}.custom-node_selected[_ngcontent-%COMP%]{border-color:#1b262c}"],changeDetection:0})}}return s})();var U={title:"Draggables",mdFile:"./index.md",category:k,demos:{DraggablesDemoComponent:E,DragHandleDemoComponent:O},order:9},d=U;var T=[];var Y={DraggablesDemoComponent:[{title:"TypeScript",code:`<pre class="ngde hljs"><code lang="typescript" class="hljs language-typescript code-lines ngde"><span class="line ngde"><span class="hljs-keyword ngde">import</span> { <span class="hljs-title class_ ngde">ChangeDetectionStrategy</span>, <span class="hljs-title class_ ngde">Component</span> } <span class="hljs-keyword ngde">from</span> <span class="hljs-string ngde">'@angular/core'</span>;
...
</span></code></pre>`}]},V=Y;var z=`<h1 id="draggables" class="ngde">Draggables<a title="Link to heading" class="ng-doc-header-link ngde" href="/features/draggables#draggables"><ng-doc-icon icon="link-2" size="16" class="ngde"></ng-doc-icon></a></h1><h2 id="disabling" class="ngde">Disabling<a title="Link to heading" class="ng-doc-header-link ngde" href="/features/draggables#disabling"><ng-doc-icon icon="link-2" size="16" class="ngde"></ng-doc-icon></a></h2><p class="ngde">You can disable <code class="ngde">draggable</code> behavior on certain <code class="ngde ng-doc-code-with-link" class="ngde"><a href="/api/ngx-vflow/type-aliases/Node" class="ng-doc-code-anchor ngde" data-link-type="TypeAlias" class="ngde">Node</a></code> or <code class="ngde ng-doc-code-with-link" class="ngde"><a href="/api/ngx-vflow/type-aliases/DynamicNode" class="ng-doc-code-anchor ngde" data-link-type="TypeAlias" class="ngde">DynamicNode</a></code> by passing <code class="ngde">false</code>.</p><ng-doc-demo-pane componentname="DraggablesDemoComponent" indexable="false" class="ngde"><div id="options" class="ngde">{}</div></ng-doc-demo-pane><h2 id="drag-handle" class="ngde">Drag handle<a title="Link to heading" class="ng-doc-header-link ngde" href="/features/draggables#drag-handle"><ng-doc-icon icon="link-2" size="16" class="ngde"></ng-doc-icon></a></h2><p class="ngde">You can restrict dragging to a specific part of node, by adding <code class="ngde">dragHandle</code> directive to this element. It's important to note that if a node contains at least one <code class="ngde">dragHandle</code>, it can only be dragged from those specific areas where <code class="ngde">dragHandle</code> was added. Otherwise, the entire node can be dragged, provided the <code class="ngde">draggable</code> property is set to <code class="ngde">true</code>.</p><ng-doc-demo-pane componentname="DragHandleDemoComponent" indexable="false" class="ngde"><div id="options" class="ngde">{}</div></ng-doc-demo-pane>`,G=(()=>{class s extends j{constructor(){super(),this.routePrefix="",this.pageType="guide",this.pageContent=z,this.editSourceFileUrl="https://github.com/artem-mangilev/ngx-vflow/edit/main/projects/ngx-vflow-demo/src/app/categories/features/pages/draggables/index.md?message=docs(draggables): describe your changes here...",this.page=d,this.demoAssets=V}static{this.\u0275fac=function(n){return new(n||s)}}static{this.\u0275cmp=l({type:s,selectors:[["ng-doc-page-features-draggables"]],standalone:!0,features:[v([{provide:j,useExisting:s},T,d.providers??[]]),x,t],decls:1,vars:0,template:function(n,e){n&1&&p(0,"ng-doc-page")},dependencies:[C],encapsulation:2,changeDetection:0})}}return s})(),$=[f(u({},(0,A.isRoute)(d.route)?d.route:{}),{path:"",component:G,title:"Draggables"})],gs=$;export{G as DynamicComponent,gs as default};
