import{a as D}from"./chunk-I2QYKT7U.js";import{a as P}from"./chunk-S3I3S5BX.js";import{d as v,f as _,n as k}from"./chunk-OTAEONLZ.js";import{a as S}from"./chunk-ALJMEAIF.js";import"./chunk-YV53NWFE.js";import"./chunk-IQL2UJ6C.js";import"./chunk-IO7LDB7E.js";import{a as w}from"./chunk-VYAX5YUU.js";import"./chunk-WI2JOD2Y.js";import{a as r}from"./chunk-34LC2K2P.js";import{T as V}from"./chunk-MU5S45C6.js";import{$b as i,Ac as c,Gb as u,Ia as m,Ob as b,Rb as f,Sb as x,Ub as y,ac as t,bc as e,tc as o,wa as p,zc as C}from"./chunk-WSOERDLG.js";import{a as h,b as j,g as M}from"./chunk-P2VZOJAX.js";var T=M(V());function A(s,d){if(s&1&&(i(0,"div",3)(1,"button",4),o(2,"Select here"),t(),e(3,"handle",5),t()),s&2){let n=d.$implicit;y("custom-node_selected",n.selected())}}function F(s,d){if(s&1&&(m(),e(0,"path",6)),s&2){let n=d.$implicit;f("d",n.path())("stroke",n.selected()?"#0f4c75":"#bbe1fa")}}var N=(()=>{class s{constructor(){this.nodes=[{id:"1",point:{x:10,y:150},type:"html-template"},{id:"2",point:{x:290,y:50},type:"default",text:"Selectable"},{id:"3",point:{x:290,y:300},type:"default",text:"Selectable"}],this.edges=[{id:"1 -> 2",source:"1",target:"2"},{id:"1 -> 3",source:"1",target:"3",type:"template"}]}static{this.\u0275fac=function(a){return new(a||s)}}static{this.\u0275cmp=p({type:s,selectors:[["ng-component"]],standalone:!0,features:[c],decls:4,vars:2,consts:[["view","auto",3,"nodes","edges"],["nodeHtml",""],["edge",""],[1,"custom-node"],["selectable","",1,"custom-node__button"],["type","source","position","right"],["selectable","","fill","none","stroke-width","2"]],template:function(a,g){a&1&&(i(0,"vflow",0),b(1,A,4,2,"ng-template",1)(2,F,1,2,"ng-template",2),t(),o(3,"`\n")),a&2&&x("nodes",g.nodes)("edges",g.edges)},dependencies:[k,S,D,_,v],styles:["[_nghost-%COMP%]{width:100%;height:100%}.custom-node[_ngcontent-%COMP%]{width:150px;height:100px;background:#bbe1fa;border:1px solid gray;border-radius:5px;display:flex;align-items:center;justify-content:center}.custom-node__button[_ngcontent-%COMP%]{border:0;outline:0;cursor:pointer;color:#fff;background-color:#1b262c;border-radius:4px;font-size:14px;font-weight:500;padding:4px 8px;display:inline-block;min-height:28px}.custom-node_selected[_ngcontent-%COMP%]{border-color:#1b262c}"],changeDetection:0})}}return s})();var L={title:"Selecting",mdFile:"./index.md",category:P,demos:{SelectingDemoComponent:N},order:2},l=L;var E=[];var U={SelectingDemoComponent:[{title:"TypeScript",code:`<pre class="ngde hljs"><code lang="typescript" class="hljs language-typescript code-lines ngde"><span class="line ngde"><span class="hljs-keyword ngde">import</span> { <span class="hljs-title class_ ngde">ChangeDetectionStrategy</span>, <span class="hljs-title class_ ngde">Component</span> } <span class="hljs-keyword ngde">from</span> <span class="hljs-string ngde">'@angular/core'</span>;
