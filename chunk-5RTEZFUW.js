import{a as _}from"./chunk-S3I3S5BX.js";import{n as N,s as u,v as E,x as y}from"./chunk-JMEWMEDY.js";import{a as D}from"./chunk-SH6HWCPG.js";import"./chunk-CQCG3KCY.js";import{a as C}from"./chunk-WT6KFS7F.js";import{Ba as h,Ga as f,Pa as o,Qa as d,R as l,Ra as j,Xa as m,aa as w,hb as v,jb as k,na as x,nb as b,ob as t,vc as $}from"./chunk-VLX6VUPD.js";import{a as g,b as r,g as F}from"./chunk-P2VZOJAX.js";var O=F($());var I=(()=>{class n{constructor(){this.nodes=[{id:"1",point:{x:100,y:100},type:"default",text:"1"},{id:"2",point:{x:200,y:200},type:"default",text:"2"}],this.edges=[]}createEdge({source:e,target:s}){this.edges=[...this.edges,{id:`${e} -> ${s}`,source:e,target:s}]}static{this.\u0275fac=function(s){return new(s||n)}}static{this.\u0275cmp=l({type:n,selectors:[["ng-component"]],standalone:!0,features:[t],decls:1,vars:2,consts:[["view","auto",3,"onConnect","nodes","edges"]],template:function(s,a){s&1&&(o(0,"vflow",0),m("onConnect",function(c){return a.createEdge(c)}),d()),s&2&&f("nodes",a.nodes)("edges",a.edges)},dependencies:[y,u],styles:["[_nghost-%COMP%]{width:100%;height:100%}"],changeDetection:0})}}return n})();var T=(()=>{class n{constructor(){this.nodes=[{id:"1",point:{x:100,y:100},type:L,data:{text:"Node 1"}},{id:"2",point:{x:200,y:200},type:L,data:{text:"Node 2"}}],this.edges=[],this.connection={mode:"loose"}}createEdge(e){let{source:s,target:a,sourceHandle:p,targetHandle:c}=e;this.edges=[...this.edges,r(g({id:`${s}${p} -> ${a}${c}`},e),{markers:{end:{type:"arrow-closed"}}})]}static{this.\u0275fac=function(s){return new(s||n)}}static{this.\u0275cmp=l({type:n,selectors:[["ng-component"]],standalone:!0,features:[t],decls:1,vars:3,consts:[["view","auto",3,"onConnect","nodes","edges","connection"]],template:function(s,a){s&1&&(o(0,"vflow",0),m("onConnect",function(c){return a.createEdge(c)}),d()),s&2&&f("nodes",a.nodes)("edges",a.edges)("connection",a.connection)},dependencies:[y,u],styles:["[_nghost-%COMP%]{width:100%;height:100%}"],changeDetection:0})}}return n})(),L=(()=>{class n extends N{static{this.\u0275fac=(()=>{let e;return function(a){return(e||(e=w(n)))(a||n)}})()}static{this.\u0275cmp=l({type:n,selectors:[["ng-component"]],standalone:!0,features:[h,t],decls:6,vars:1,consts:[[1,"node"],["type","source","position","top","id","a"],["type","source","position","right","id","b"],["type","source","position","bottom","id","c"],["type","source","position","left","id","d"]],template:function(s,a){if(s&1&&(o(0,"div",0),v(1),j(2,"handle",1)(3,"handle",2)(4,"handle",3)(5,"handle",4),d()),s&2){let p;x(),k(" ",(p=a.data())==null?null:p.text," ")}},dependencies:[E],styles:[".node[_ngcontent-%COMP%]{width:100px;height:50px;border:1.5px solid #1b262c;border-radius:5px;display:flex;align-items:center;justify-content:center;color:#000;background-color:#fff}"],changeDetection:0})}}return n})();var M={title:"Connection",mdFile:"./index.md",category:_,demos:{DefaultConnectionDemoComponent:I,LooseConnectionDemoComponent:T},order:3},i=M;var V=[];var H={DefaultConnectionDemoComponent:[{title:"TypeScript",code:`<pre class="ngde hljs"><code lang="typescript" class="hljs language-typescript code-lines ngde"><span class="line ngde"><span class="hljs-keyword ngde">import</span> { <span class="hljs-title class_ ngde">ChangeDetectionStrategy</span>, <span class="hljs-title class_ ngde">Component</span> } <span class="hljs-keyword ngde">from</span> <span class="hljs-string ngde">'@angular/core'</span>;
...
</span><span class="line ngde">  <span class="hljs-title class_ ngde"><a href="/api/ngx-vflow/classes/CustomNodeComponent" class="ng-doc-code-anchor ngde" data-link-type="Directive" class="ngde">CustomNodeComponent</a></span>,
