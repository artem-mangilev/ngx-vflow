...
</span></code></pre><h2 id="example" class="ngde">Example<a title="Link to heading" class="ng-doc-header-link ngde" href="/features/edges/labels#example"><ng-doc-icon icon="link-2" size="16" class="ngde"></ng-doc-icon></a></h2><ng-doc-demo-pane componentname="LabelsDemoComponent" indexable="false" class="ngde"><div id="options" class="ngde">{}</div></ng-doc-demo-pane>`,Y=(()=>{class s extends g{constructor(){super(),this.routePrefix="",this.pageType="guide",this.pageContent=I,this.editSourceFileUrl="https://github.com/artem-mangilev/ngx-vflow/edit/main/projects/ngx-vflow-demo/src/app/categories/features/categories/edges/labels/index.md?message=docs(labels): describe your changes here...",this.page=l,this.demoAssets=P}static{this.\u0275fac=function(n){return new(n||s)}}static{this.\u0275cmp=t({type:s,selectors:[["ng-doc-page-features-edges-labels"]],standalone:!0,features:[v([{provide:g,useExisting:s},T,l.providers??[]]),m,p],decls:1,vars:0,template:function(n,a){n&1&&y(0,"ng-doc-page")},dependencies:[C],encapsulation:2,changeDetection:0})}}return s})(),z=[o(i({},(0,S.isRoute)(l.route)?l.route:{}),{path:"",component:Y,title:"Labels"})],ns=z;export{Y as DynamicComponent,ns as default};
