...
Дата: 2026-09-12, этап 3. Полный список программных параметров оформления core и замен по CSS-контракту. Удаление выполняется на этапе 7; на этапе 3 inputs сохранены, изменены только их значения по умолчанию: вместо литералов подставлены токены `--vflow-*` с прежними значениями как fallback.
