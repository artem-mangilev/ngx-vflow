...
- `VflowComponent.resolvedShortcuts: Signal<ResolvedKeyboardShortcuts>`: the merged result after defaults, application-wide config and the input, per section, with parsed bindings and their formatted labels (issue 04's formatter).
