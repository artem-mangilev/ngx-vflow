...
- Represent selected, policy-disabled, and connection-validity states accessibly.
...
- Tests cover policy-disabled, selected, grouped, and invalid-connection states.
