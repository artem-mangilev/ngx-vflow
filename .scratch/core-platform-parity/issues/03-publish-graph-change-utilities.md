...
- Removing a node cascades to its descendants and all incident edges by default. Issue 03 owns these deterministic mechanics; issue 06 owns request, veto/replacement, and reporting lifecycle.
