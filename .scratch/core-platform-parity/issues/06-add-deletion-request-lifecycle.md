...
Deleting selected entities is an official recipe. Core cannot consistently apply deletability rules, calculate cascades, support keyboard deletion, or let the application veto and replace the requested operation.
...
- Apply per-entity deletion policies before presenting the request.
...
- Non-deletable entities remain and produce a predictable request/result.
