  ...
  it('does not show an edge before its custom endpoints are measured', async () => {
    ...
    const sample = () => {
      ...
      const paths = Array.from(
        fixture.nativeElement.querySelectorAll('svg[edge] .focus-indicator, [edgeLabel]'),
      ) as Element[];
    ...
    expect(fixture.nativeElement.querySelector('svg[edge] .focus-indicator')?.getAttribute('d')).toBeTruthy();
