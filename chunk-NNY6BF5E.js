import{a as u}from"./chunk-DV74VKYN.js";import"./chunk-S3I3S5BX.js";import{x as f}from"./chunk-3MWKOPTV.js";import{a as m}from"./chunk-GPBMHN32.js";import"./chunk-MUKF72JZ.js";import{a as o}from"./chunk-T6GQPSCF.js";import{Ba as g,Ga as r,R as a,Ta as t,pb as h,qb as l,xc as w}from"./chunk-FDES3R26.js";import{a as c,b as i,g as v}from"./chunk-P2VZOJAX.js";var x=v(w());var j=(()=>{class s{constructor(){this.nodes=[{id:"1",point:{x:100,y:100},type:"default",text:"1"},{id:"2",point:{x:200,y:200},type:"default",text:"<strong>2</strong>"}]}static{this.\u0275fac=function(n){return new(n||s)}}static{this.\u0275cmp=a({type:s,selectors:[["ng-component"]],standalone:!0,features:[l],decls:1,vars:1,consts:[["view","auto",3,"nodes"]],template:function(n,d){n&1&&t(0,"vflow",0),n&2&&r("nodes",d.nodes)},dependencies:[f],styles:["[_nghost-%COMP%]{width:100%;height:100%}"],changeDetection:0})}}return s})();var N={title:"Default nodes",mdFile:"./index.md",category:u,demos:{DefaultNodesDemoComponent:j},order:1},e=N;var y=[];var P={DefaultNodesDemoComponent:[{title:"TypeScript",code:`<pre class="ngde hljs"><code lang="typescript" class="hljs language-typescript code-lines ngde"><span class="line ngde"><span class="hljs-keyword ngde">import</span> { <span class="hljs-title class_ ngde">ChangeDetectionStrategy</span>, <span class="hljs-title class_ ngde">Component</span> } <span class="hljs-keyword ngde">from</span> <span class="hljs-string ngde">'@angular/core'</span>;
...
</span></code></pre>`}]},D=P;var k='<h1 id="default-nodes" class="ngde">Default nodes<a title="Link to heading" class="ng-doc-header-link ngde" href="/features/nodes/default-nodes#default-nodes"><ng-doc-icon icon="link-2" size="16" class="ngde"></ng-doc-icon></a></h1><p class="ngde">To get started, you just need to provide <code class="ngde">nodes</code> array to <code class="ngde">vflow</code> component.</p><ng-doc-demo-pane componentname="DefaultNodesDemoComponent" indexable="false" class="ngde"><div id="options" class="ngde">{}</div></ng-doc-demo-pane>',b=(()=>{class s extends o{constructor(){super(),this.routePrefix="",this.pageType="guide",this.pageContent=k,this.editSourceFileUrl="https://github.com/artem-mangilev/ngx-vflow/edit/main/projects/ngx-vflow-demo/src/app/categories/features/categories/nodes/default-nodes/index.md?message=docs(default-nodes): describe your changes here...",this.page=e,this.demoAssets=D}static{this.\u0275fac=function(n){return new(n||s)}}static{this.\u0275cmp=a({type:s,selectors:[["ng-doc-page-features-nodes-default-nodes"]],standalone:!0,features:[h([{provide:o,useExisting:s},y,e.providers??[]]),g,l],decls:1,vars:0,template:function(n,d){n&1&&t(0,"ng-doc-page")},dependencies:[m],encapsulation:2,changeDetection:0})}}return s})(),O=[i(c({},(0,x.isRoute)(e.route)?e.route:{}),{path:"",component:b,title:"Default nodes"})],Y=O;export{b as DynamicComponent,Y as default};
