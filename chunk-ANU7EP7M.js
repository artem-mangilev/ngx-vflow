import{a as N}from"./chunk-S3I3S5BX.js";import{f as V,n as $}from"./chunk-3MEYFIMA.js";import"./chunk-IQL2UJ6C.js";import{a as I}from"./chunk-ALJMEAIF.js";import"./chunk-YV53NWFE.js";import"./chunk-IO7LDB7E.js";import{a as O}from"./chunk-VYAX5YUU.js";import"./chunk-WI2JOD2Y.js";import{a as v}from"./chunk-34LC2K2P.js";import{T as U}from"./chunk-MU5S45C6.js";import{$b as c,Ac as u,Ga as k,Gb as S,Ha as D,Ia as f,Jc as b,Ob as m,Rb as x,Sb as d,Ub as H,Xb as y,ac as g,bc as e,fc as T,hc as P,ic as i,pb as t,sc as C,tc as o,wa as j,zc as E}from"./chunk-WSOERDLG.js";import{a as _,b as w,g as q}from"./chunk-P2VZOJAX.js";var F=q(U());function Y(n,p){if(n&1&&(c(0,"div",4)(1,"div",5),o(2," Output 1 "),e(3,"handle",6),g(),c(4,"div",5),o(5," Output 2 "),e(6,"handle",6),g()()),n&2){let s=i().$implicit;i();let a=C(3);t(3),d("id",s.node.data.output1)("template",a),t(3),d("id",s.node.data.output2)("template",a)}}function z(n,p){if(n&1&&(c(0,"div",4)(1,"div",5),o(2," Input 1 "),e(3,"handle",7),g(),c(4,"div",5),o(5," Input 2 "),e(6,"handle",7),g()()),n&2){let s=i().$implicit;i();let a=C(5);t(3),d("id",s.node.data.input1)("template",a),t(3),d("id",s.node.data.input2)("template",a)}}function B(n,p){if(n&1&&m(0,Y,7,4,"div",4)(1,z,7,4,"div",4),n&2){let s=p.$implicit;y(0,s.node.data.type==="output"?0:-1),t(),y(1,s.node.data.type==="input"?1:-1)}}function J(n,p){if(n&1&&(f(),e(0,"circle",8)),n&2){let s=p.$implicit;x("cx",s.point().x)("cy",s.point().y)}}function K(n,p){if(n&1&&(f(),e(0,"rect",9)),n&2){let s=p.$implicit;H("handle_idle",s.state()==="idle")("handle_valid",s.state()==="valid")("handle_invalid",s.state()==="invalid"),x("x",s.point().x-5)("y",s.point().y-5)}}var M=(()=>{class n{constructor(){this.nodes=[{id:"1",point:{x:0,y:150},type:"html-template",data:{type:"output",output1:"output1",output2:"output2"}},{id:"2",point:{x:250,y:100},type:"html-template",data:{type:"input",input1:"input1",input2:"input2"}}],this.edges=[],this.connectionSettings={validator:s=>s.target==="2"&&s.targetHandle==="input1"}}createEdge({source:s,target:a,sourceHandle:l,targetHandle:h}){this.edges=[...this.edges,{id:`${s} -> ${a}${l??""}${h??""}`,markers:{start:{type:"arrow-closed"},end:{type:"arrow-closed"}},source:s,target:a,sourceHandle:l,targetHandle:h}]}static{this.\u0275fac=function(a){return new(a||n)}}static{this.\u0275cmp=j({type:n,selectors:[["ng-component"]],standalone:!0,features:[u],decls:6,vars:3,consts:[["handleTemplate",""],["squareHandleTemplate",""],["view","auto",3,"onConnect","nodes","edges","connection"],["nodeHtml",""],[1,"custom-node"],[1,"data-block"],["position","right","type","source",3,"id","template"],["position","left","type","target",3,"id","template"],["stroke-width","1","stroke","black","r","6","fill","#1b262c"],["width","10","height","10","stroke-width","1","stroke","black","rx","1","ry","1"]],template:function(a,l){if(a&1){let h=T();c(0,"vflow",2),P("onConnect",function(G){return k(h),D(l.createEdge(G))}),m(1,B,2,2,"ng-template",3),g(),m(2,J,1,2,"ng-template",null,0,b)(4,K,1,8,"ng-template",null,1,b)}a&2&&d("nodes",l.nodes)("edges",l.edges)("connection",l.connectionSettings)},dependencies:[$,I,V],styles:["[_nghost-%COMP%]{width:100%;height:100%}.custom-node[_ngcontent-%COMP%]{width:150px;height:100px;background-color:#0f4c75;border:1px solid gray;border-radius:5px;align-items:center;padding-left:7px;padding-right:7px}.data-block[_ngcontent-%COMP%]{background-color:#fff;color:#1b262c;margin-top:15px;border-radius:5px;text-align:center}.handle_idle[_ngcontent-%COMP%]{fill:#fff}.handle_valid[_ngcontent-%COMP%]{fill:green}.handle_invalid[_ngcontent-%COMP%]{fill:red}"],changeDetection:0})}}return n})();var Q={title:"Custom handles",mdFile:"./index.md",category:N,demos:{CustomHandlesDemoComponent:M},order:2},r=Q;var R=[];var W={CustomHandlesDemoComponent:[{title:"TypeScript",code:`<pre class="ngde hljs"><code lang="typescript" class="hljs language-typescript code-lines ngde"><span class="line ngde"><span class="hljs-keyword ngde">import</span> { <span class="hljs-title class_ ngde">ChangeDetectionStrategy</span>, <span class="hljs-title class_ ngde">Component</span> } <span class="hljs-keyword ngde">from</span> <span class="hljs-string ngde">'@angular/core'</span>;
</span><span class="line ngde"><span class="hljs-keyword ngde">import</span> { <span class="hljs-title class_ ngde"><a href="/api/ngx-vflow/interfaces/Edge" class="ng-doc-code-anchor ngde" data-link-type="Interface" class="ngde">Edge</a></span>, <span class="hljs-title class_ ngde"><a href="/api/ngx-vflow/type-aliases/Node" class="ng-doc-code-anchor ngde" data-link-type="TypeAlias" class="ngde">Node</a></span>, <span class="hljs-title class_ ngde"><a href="/api/ngx-vflow/variables/Vflow" class="ng-doc-code-anchor ngde" data-link-type="Variable" class="ngde">Vflow</a></span>, <span class="hljs-title class_ ngde"><a href="/api/ngx-vflow/interfaces/Connection" class="ng-doc-code-anchor ngde" data-link-type="Interface" class="ngde">Connection</a></span>, <span class="hljs-title class_ ngde"><a href="/api/ngx-vflow/interfaces/ConnectionSettings" class="ng-doc-code-anchor ngde" data-link-type="Interface" class="ngde">ConnectionSettings</a></span> } <span class="hljs-keyword ngde">from</span> <span class="hljs-string ngde">'projects/ngx-vflow-lib/src/public-api'</span>;
...
</span></code></pre>`},{title:"HTML",code:`<pre class="ngde hljs"><code lang="html" class="hljs language-html code-lines ngde"><span class="line ngde"><span class="hljs-tag ngde">&#x3C;<span class="hljs-name ngde">vflow</span> <span class="hljs-attr ngde">view</span>=<span class="hljs-string ngde">"auto"</span> [<span class="hljs-attr ngde">nodes</span>]=<span class="hljs-string ngde">"nodes"</span> [<span class="hljs-attr ngde">edges</span>]=<span class="hljs-string ngde">"edges"</span> (<span class="hljs-attr ngde">onConnect</span>)=<span class="hljs-string ngde">"createEdge($event)"</span> [<span class="hljs-attr ngde">connection</span>]=<span class="hljs-string ngde">"connectionSettings"</span>></span>
...
</span></code></pre><ng-doc-demo-pane componentname="CustomHandlesDemoComponent" indexable="false" class="ngde"><div id="options" class="ngde">{}</div></ng-doc-demo-pane>`,Z=(()=>{class n extends v{constructor(){super(),this.routePrefix="",this.pageType="guide",this.pageContent=X,this.editSourceFileUrl="https://github.com/artem-mangilev/ngx-vflow/edit/main/projects/ngx-vflow-demo/src/app/categories/features/pages/custom-handles/index.md?message=docs(custom-handles): describe your changes here...",this.page=r,this.demoAssets=A}static{this.\u0275fac=function(a){return new(a||n)}}static{this.\u0275cmp=j({type:n,selectors:[["ng-doc-page-features-custom-handles"]],standalone:!0,features:[E([{provide:v,useExisting:n},R,r.providers??[]]),S,u],decls:1,vars:0,template:function(a,l){a&1&&e(0,"ng-doc-page")},dependencies:[O],encapsulation:2,changeDetection:0})}}return n})(),ss=[w(_({},(0,F.isRoute)(r.route)?r.route:{}),{path:"",component:Z,title:"Custom handles"})],js=ss;export{Z as DynamicComponent,js as default};
