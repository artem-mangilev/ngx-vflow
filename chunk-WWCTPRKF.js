import{a as E}from"./chunk-UUHU3CBA.js";import"./chunk-S3I3S5BX.js";import{t as y,z as u}from"./chunk-AQENXFQJ.js";import{h as b,k as N}from"./chunk-NA7FJBPQ.js";import{a as _}from"./chunk-ZBKCENK6.js";import"./chunk-G5N4YGVJ.js";import{a as C}from"./chunk-AKRIWIS4.js";import{T as $}from"./chunk-QMHLIXQX.js";import{$b as d,Ac as t,Gb as h,Ka as w,Qb as f,ac as o,bc as j,hc as m,pb as x,tc as v,vc as k,wa as l,zc as D}from"./chunk-Z42XPK5A.js";import{a as g,b as r,g as F}from"./chunk-ODLL2QMY.js";var O=F($());var I=(()=>{class n{constructor(){this.nodes=[{id:"1",point:{x:100,y:100},type:"default",text:"1"},{id:"2",point:{x:200,y:200},type:"default",text:"2"}],this.edges=[]}createEdge({source:e,target:s}){this.edges=[...this.edges,{id:`${e} -> ${s}`,source:e,target:s}]}static{this.\u0275fac=function(s){return new(s||n)}}static{this.\u0275cmp=l({type:n,selectors:[["ng-component"]],standalone:!0,features:[t],decls:1,vars:2,consts:[["view","auto",3,"connect","nodes","edges"]],template:function(s,a){s&1&&(d(0,"vflow",0),m("connect",function(p){return a.createEdge(p)}),o()),s&2&&f("nodes",a.nodes)("edges",a.edges)},dependencies:[u,y],styles:["[_nghost-%COMP%]{width:100%;height:100%}"],changeDetection:0})}}return n})();var T=(()=>{class n{constructor(){this.nodes=[{id:"1",point:{x:100,y:100},type:L,data:{text:"Node 1"}},{id:"2",point:{x:200,y:200},type:L,data:{text:"Node 2"}}],this.edges=[],this.connection={mode:"loose"}}createEdge(e){let{source:s,target:a,sourceHandle:c,targetHandle:p}=e;this.edges=[...this.edges,r(g({id:`${s}${c} -> ${a}${p}`},e),{markers:{end:{type:"arrow-closed"}}})]}static{this.\u0275fac=function(s){return new(s||n)}}static{this.\u0275cmp=l({type:n,selectors:[["ng-component"]],standalone:!0,features:[t],decls:1,vars:3,consts:[["view","auto",3,"connect","nodes","edges","connection"]],template:function(s,a){s&1&&(d(0,"vflow",0),m("connect",function(p){return a.createEdge(p)}),o()),s&2&&f("nodes",a.nodes)("edges",a.edges)("connection",a.connection)},dependencies:[u,y],styles:["[_nghost-%COMP%]{width:100%;height:100%}"],changeDetection:0})}}return n})(),L=(()=>{class n extends b{static{this.\u0275fac=(()=>{let e;return function(a){return(e||(e=w(n)))(a||n)}})()}static{this.\u0275cmp=l({type:n,selectors:[["ng-component"]],standalone:!0,features:[h,t],decls:6,vars:1,consts:[[1,"node"],["type","source","position","top","id","a"],["type","source","position","right","id","b"],["type","source","position","bottom","id","c"],["type","source","position","left","id","d"]],template:function(s,a){if(s&1&&(d(0,"div",0),v(1),j(2,"handle",1)(3,"handle",2)(4,"handle",3)(5,"handle",4),o()),s&2){let c;x(),k(" ",(c=a.data())==null?null:c.text," ")}},dependencies:[N],styles:[".node[_ngcontent-%COMP%]{width:100px;height:50px;border:1.5px solid #1b262c;border-radius:5px;display:flex;align-items:center;justify-content:center;color:#000;background-color:#fff}"],changeDetection:0})}}return n})();var M={title:"Connection",mdFile:"./index.md",category:E,demos:{DefaultConnectionDemoComponent:I,LooseConnectionDemoComponent:T},order:2},i=M;var V=[];var H={DefaultConnectionDemoComponent:[{title:"TypeScript",code:`<pre class="ngde hljs"><code lang="typescript" class="hljs language-typescript code-lines ngde"><span class="line ngde"><span class="hljs-keyword ngde">import</span> { <span class="hljs-title class_ ngde">ChangeDetectionStrategy</span>, <span class="hljs-title class_ ngde">Component</span> } <span class="hljs-keyword ngde">from</span> <span class="hljs-string ngde">'@angular/core'</span>;
...
</span><span class="line ngde">  <span class="hljs-attr ngde">template</span>: <span class="hljs-string ngde">\`&#x3C;vflow view="auto" [nodes]="nodes" [edges]="edges" (connect)="createEdge($event)" /> \`</span>,
...
</span><span class="line ngde"><span class="hljs-string ngde">    &#x3C;vflow view="auto" [nodes]="nodes" [edges]="edges" [connection]="connection" (connect)="createEdge($event)" /></span>
</span><span class="line ngde"><span class="hljs-string ngde">  \`</span>,
</span><span class="line ngde">  <span class="hljs-attr ngde">styles</span>: [
</span><span class="line ngde">    <span class="hljs-string ngde">\`</span>
</span><span class="line ngde"><span class="hljs-string ngde">      :host {</span>
...
</span></code></pre>`}]},P=H;var R=`<h1 id="connection" class="ngde">Connection<a title="Link to heading" class="ng-doc-header-link ngde" href="/features/edges/connection#connection"><ng-doc-icon icon="link-2" size="16" class="ngde"></ng-doc-icon></a></h1><p class="ngde">Edges are not creating automatically. To create a new edge, follow these steps:</p><ol class="ngde"><li class="ngde">Create handler to the <code class="ngde">(connect)</code> event</li><li class="ngde">This handler accepts a <code class="ngde ng-doc-code-with-link" class="ngde"><a href="/api/ngx-vflow/interfaces/Connection" class="ng-doc-code-anchor ngde" data-link-type="Interface" class="ngde">Connection</a></code> argument. <code class="ngde ng-doc-code-with-link" class="ngde"><a href="/api/ngx-vflow/interfaces/Connection" class="ng-doc-code-anchor ngde" data-link-type="Interface" class="ngde">Connection</a></code> is similar to an <code class="ngde ng-doc-code-with-link" class="ngde"><a href="/api/ngx-vflow/interfaces/Edge" class="ng-doc-code-anchor ngde" data-link-type="Interface" class="ngde">Edge</a></code>, but it doesn't exists in the flow, you need to "convert" it into a new <code class="ngde ng-doc-code-with-link" class="ngde"><a href="/api/ngx-vflow/interfaces/Edge" class="ng-doc-code-anchor ngde" data-link-type="Interface" class="ngde">Edge</a></code></li><li class="ngde">Update the <code class="ngde">Edge[]</code> list with the new edge that was created from the <code class="ngde ng-doc-code-with-link" class="ngde"><a href="/api/ngx-vflow/interfaces/Connection" class="ng-doc-code-anchor ngde" data-link-type="Interface" class="ngde">Connection</a></code>.</li></ol><h2 id="strict-connections" class="ngde">Strict connections<a title="Link to heading" class="ng-doc-header-link ngde" href="/features/edges/connection#strict-connections"><ng-doc-icon icon="link-2" size="16" class="ngde"></ng-doc-icon></a></h2><p class="ngde">In the default <code class="ngde">'strict'</code> <code class="ngde">mode</code> of <code class="ngde ng-doc-code-with-link" class="ngde"><a href="/api/ngx-vflow/interfaces/ConnectionSettings" class="ng-doc-code-anchor ngde" data-link-type="Interface" class="ngde">ConnectionSettings</a></code>, edges are created from connections with strict adherence to the <code class="ngde">source</code> and <code class="ngde">target</code> types of the <code class="ngde ng-doc-code-with-link" class="ngde"><a href="/api/ngx-vflow/classes/HandleComponent" class="ng-doc-code-anchor ngde" data-link-type="Component" class="ngde">HandleComponent</a></code>. This means connections can only be established in one direction based on these properties.</p><ng-doc-demo-pane componentname="DefaultConnectionDemoComponent" indexable="false" class="ngde"><div id="options" class="ngde">{}</div></ng-doc-demo-pane><h2 id="loose-connections" class="ngde">Loose connections<a title="Link to heading" class="ng-doc-header-link ngde" href="/features/edges/connection#loose-connections"><ng-doc-icon icon="link-2" size="16" class="ngde"></ng-doc-icon></a></h2><p class="ngde">This is the <code class="ngde">'loose'</code> <code class="ngde">mode</code> of <code class="ngde ng-doc-code-with-link" class="ngde"><a href="/api/ngx-vflow/interfaces/ConnectionSettings" class="ng-doc-code-anchor ngde" data-link-type="Interface" class="ngde">ConnectionSettings</a></code>, where the flow ignores the handle <code class="ngde">type</code> and allows any handle to connect with any other handle. In this mode, an <code class="ngde">id</code> must be provided for the <code class="ngde ng-doc-code-with-link" class="ngde"><a href="/api/ngx-vflow/classes/HandleComponent" class="ng-doc-code-anchor ngde" data-link-type="Component" class="ngde">HandleComponent</a></code> to function correctly.</p><ng-doc-demo-pane componentname="LooseConnectionDemoComponent" indexable="false" class="ngde"><div id="options" class="ngde">{}</div></ng-doc-demo-pane>`,U=(()=>{class n extends C{constructor(){super(),this.routePrefix="",this.pageType="guide",this.pageContent=R,this.editSourceFileUrl="https://github.com/artem-mangilev/ngx-vflow/edit/main/projects/ngx-vflow-demo/src/app/categories/features/categories/edges/connection/index.md?message=docs(connection): describe your changes here...",this.page=i,this.demoAssets=P}static{this.\u0275fac=function(s){return new(s||n)}}static{this.\u0275cmp=l({type:n,selectors:[["ng-doc-page-features-edges-connection"]],standalone:!0,features:[D([{provide:C,useExisting:n},V,i.providers??[]]),h,t],decls:1,vars:0,template:function(s,a){s&1&&j(0,"ng-doc-page")},dependencies:[_],encapsulation:2,changeDetection:0})}}return n})(),G=[r(g({},(0,O.isRoute)(i.route)?i.route:{}),{path:"",component:U,title:"Connection"})],cs=G;export{U as DynamicComponent,cs as default};
